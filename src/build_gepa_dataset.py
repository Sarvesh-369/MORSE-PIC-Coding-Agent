...
class BuildGEPADataset:
    def __init__(self, max_train_per_context: int = 5, max_val_per_context: int = 10, context_to_exclude: list[str] = ["natural image", "medical image", "synthetic scene"], output_dir="data", save_dataset=False, random_seed: int = 42):
